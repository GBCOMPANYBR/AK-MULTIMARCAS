    ...
    const vehicle = await prisma.vehicle.upsert({
      ...
      create: {
        ...
        images: {
          create: [
            {
              url: `https://picsum.photos/seed/${v.slug}/800/600`,
              isPrimary: true,
              order: 0,
            },
            {
              url: `https://picsum.photos/seed/${v.slug}-2/800/600`,
              isPrimary: false,
              order: 1,
            },
          ],
    ...
    data: [
      {
        ...
        date: daysFromNow(-10),
        description: "Locação concluída - Fiat Mobi",
        vehicleId: completedVehicle.id,
      },
      {
        type: "DESPESA",
  ...
  await prisma.testimonial.createMany({
    data: [
      ...
      },
      {
        ...
        rating: 5,
        text: "Já aluguei um Porsche Macan pra um evento e a experiência foi incrível, carro impecável.",
        order: 3,
      },
    ],
  });
